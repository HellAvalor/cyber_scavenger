 ...
 */
public class ANewWorldController  extends InputAdapter implements Disposable {
    private static final String TAG = ANewWorldController.class.getName();
...
//        initPhysics();
    ...
    public ANewWorldController(DirectedGame game)
    {
        this.game = game;
        init();
    }
